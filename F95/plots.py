...
plt.xlabel('Kameraverschiebung [cm]')
plt.ylabel('Bildverschiebung [pixel]')
plt.xlim(0,40)
plt.ylim(0,140)
plt.errorbar(distance, pixels, xerr=distance_err, fmt='.', label='Messwerte')
...
ax1.label_outer()
plt.xlabel('Shift von Paramter 0')
plt.xlim(0,15)
ax1.set_title('MI Metrik', color='blue')
ax1.set_ylim(-1,0)
ax1.plot(ct2ct_params[0][:,0], ct2ct_params[0][:,1], color='blue')
ax2.set_title('MSD Metrik', color='red')
ax2.set_ylim(0,3e5)
...
ax2 = plt.subplot(212, sharex = ax1)
ax1.label_outer()
plt.xlabel('Shift von Paramter 1')
plt.xlim(0,15)
ax1.set_title('MI Metrik', color='blue')
ax1.set_ylim(-1,0)
...
ax2 = plt.subplot(212, sharex = ax1)
ax1.label_outer()
plt.xlabel('Shift von Paramter 2')
plt.xlim(0,15)
ax1.set_title('MI Metrik', color='blue')
ax1.set_ylim(-1,0)
...
ax2 = plt.subplot(212, sharex = ax1)
ax1.label_outer()
plt.xlabel('Shift von Paramter 3')
plt.xlim(-25,25)
ax1.set_title('MI Metrik', color='blue')
ax1.set_ylim(-1.5,0)
...
ax2 = plt.subplot(212, sharex = ax1)
ax1.label_outer()
plt.xlabel('Shift von Paramter 4')
plt.xlim(-25,25)
ax1.set_title('MI Metrik', color='blue')
ax1.set_ylim(-1.5,0)
...
ax2 = plt.subplot(212, sharex = ax1)
ax1.label_outer()
plt.xlabel('Shift von Paramter 5')
plt.xlim(0,30)
ax1.set_title('MI Metrik', color='blue')
...
plt.xlim(0,1)
ax1.grid(False)
ax1.set_ylabel('MI Metrik', color='blue')
ax1.set_ylim(-0.8,0)
ax1.tick_params(axis='y', colors='blue')
ax1.plot(ct2mrt_param0[:,0], ct2mrt_param0[:,1], color='blue')
ax2 = ax1.twinx()
ax2.grid(False)
ax2.set_ylabel('MSD Metrik', color='red')
...
plt.xlabel('Shift von Parameter 0')
plt.ylabel('MI Metrik')
plt.xlim(0,1)
plt.ylim(-0.7,0)
...
plt.xlabel('Shift von Parameter 3')
plt.ylabel('MI Metrik')
plt.xlim(0,1)
plt.ylim(-0.75,0)
...
plt.xlabel('Samplingrate')
plt.ylabel('Berechnungsdauer [s]')
plt.xlim(0,1.05)
plt.ylim(0,52.5)
plt.errorbar(sampling_rate, time, yerr=time_err, fmt='.', label='Messwerte')
...
plt.xlabel('Gitterpunkte pro Dimension')
plt.ylabel('Berechnungsdauer [s]')
plt.xlim(0,103)
plt.ylim(-1,35)
plt.errorbar(gppd, time, yerr=time_err, fmt='.', label='Messwerte')
